---
title: "Improve a voice for AI Cover"
api: "POST https://docs.myvocal.ai/sound_clone/api/v1/voices/vc/{voiceId}"
header: "content-type: multipart/form-data"
description: "Edit a custom voice for AI Cover feature. You can upload more files to improve a custom voice(❗❗❗File-related interfaces are not supported, please use interface tools for requests.)"
---
