---
title: "Delete AI Cover"
api: "DELETE https://api.myvocal.ai/sound_clone/api/v1/cover"
description: "Delete up to 500 tts history items once by ai_cover_id."
---
### Header
...
<ResponseField name="unMatchIds" type="array">
 Ids included do not belong to this feature.
</ResponseField>
...
curl --location --request DELETE 'https://api.myvocal.ai/sound_clone/api/v1/cover' \
