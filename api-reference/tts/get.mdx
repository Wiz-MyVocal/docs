...
description: "Generate a text-to-speech audio using a voice of your choice and returns audio.(❗❗❗File-related interfaces are not supported, please use interface tools for requests.)"
---
### Header
