...
api: "POST https://test.myvocal.ai/sound_clone/sound_clone/api/v1/tts"
description: "Generate a text-to-speech audio using a voice of your choice and returns audio."
---
### Header
