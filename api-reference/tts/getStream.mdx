...
### Header
<ParamField header="success"   type="string" >
    If the request is successful, this value in the callback is <b>true</b>.
</ParamField>
...
curl -X 'POST' \
'https://api.myvocal.ai/sound_clone/api/v1/tts/stream' \
