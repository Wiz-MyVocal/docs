...
api: "POST https://test.myvocal.ai/sound_clone/sound_clone/api/v1/tts/stream"
description: "Generate a text-to-speech audio using a voice of your choice and returns audio stream."
---
### Header
...
curl -X 'POST' \
'https://test.myvocal.ai/sound_clone/sound_clone/api/v1/tts/create' \
