---
title: "Get AI Cover URL"
api: "POST https://api.myvocal.ai/sound_clone/api/v1/cover/query"
description: "Get ai cover audio url."
---
### Header
...
curl --location 'https://api.myvocal.ai/sound_clone/api/v1/cover/query' \
