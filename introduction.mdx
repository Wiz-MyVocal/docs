...
<p>
If you require API services, you need to subscribe to at least the Pro plan and then copy your <b>API-Key</b> on <a href="https://www.myvocal.ai/account" target="_blank">Account Info page</a>.
</p>
<p>
